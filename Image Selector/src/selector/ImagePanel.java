...
/**
 * A Swing component that displays an image and facilitates interaction with it in order to select a
 * region of the image.  The image and selection model can both be changed, and a placeholder label
 * is shown if no valid image has been set.
 */
